...
public final class ProductService {
    ...
    public List<ProductDto> search(ProductSearchCriteria criteria) {
        ...
        QueryBuilder query = new QueryBuilder("/api/products/search")
                .add("keyword", criteria.getKeyword())
                .add("categoryId", criteria.getCategoryId())
                .add("cityId", criteria.getCityId())
                .add("minPrice", criteria.getMinPrice())
                .add("maxPrice", criteria.getMaxPrice())
                .add("sortBy", criteria.getSortBy() == null ? null : criteria.getSortBy().getApiValue());
    ...
    public void create(String title, String description, long price, long categoryId,
                       int cityId, List<Path> images) {
        MultipartBody body = new MultipartBody()
                .addText("title", title)
                .addText("description", description == null ? "" : description)
                .addText("price", Long.toString(price))
                .addText("categoryId", Long.toString(categoryId))
                .addText("cityId", Integer.toString(cityId));
        if (images != null) {
